						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-12">
									...
									<button class="btn btn-outline-dark btn-sm" data-toggle="collapse" data-target="#demo"><i class="fas fa-angle-down"></i> Mostrar Cookies <i class="fas fa-angle-down"></i></button>
