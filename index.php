			...
			<div class="section-3-container section-container " id="section-3">
				<div class="container">
					...
					<div class="carousel" data-flickity='{ "draggable": true,
						...
						<?php
						$queryNosotros = "SELECT * FROM tab_nosotros WHERE Sucursal = 'Mayoreo'";
						$rsNosotros = mysqli_query($con, $queryNosotros) or die("Error de consulta");
						while ($Nosotros = mysqli_fetch_array($rsNosotros)) {
							echo '
									<div class="carousel-nosotros">
										<div class="col-12">
											<h1>'.$Nosotros['Mision'].'</h1>
											<h1><i class="fas fa-bullseye"></i></h1>
											<h4>'.$Nosotros['Mision_txt'].'</h4>
										</div>
									</div>
									<div class="carousel-nosotros">
										<div class="col-12">
											<h1>'.$Nosotros['Vision'].'</h1>
											<h1><i class="far fa-eye"></i></h1>
											<h4>'.$Nosotros['Vision_txt'].'</h4>
										</div>
									</div>
									<div class="carousel-nosotros">
										<div class="col-12">
											<h1>'.$Nosotros['Adicional'].'</h1>
											<h1><i class="fas fa-hands-helping"></i></h1>
											<h4>'.$Nosotros['Adicional_txt1'].'</h4>
											<h4>'.$Nosotros['Adicional_txt2'].'</h4>
											<h4>'.$Nosotros['Adicional_txt3'].'</h4>
											<h4>'.$Nosotros['Adicional_txt4'].'</h4>
											<h4>'.$Nosotros['Adicional_txt5'].'</h4>
										</div>
									</div>
								';
						}
		...
		<div class="modal-dialog">
			...
			<div class="modal-content" style="background-color: transparent;">
				...
				<div class="carousel" style="background: transparent;" data-flickity='{ "draggable": true,
					...
					<?php
					$queryModalPromocion = "SELECT * FROM tab_modal_promocion";
