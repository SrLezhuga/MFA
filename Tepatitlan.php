						...
						<div class="col-12">
							...
							<div class="jumbotron jumbotron-fluid <?php echo $Sucursal; ?>">
								<div class="container">
									...
									<h1 class="wow  slideInDown" style="visibility: visible; visible; color: white;  animation-name: slideInDown;"><b><?php echo $Web['Titulo']; ?></b></h1>
							...
							<div class="row">
								...
								<div class="col-12">
									...
									"pageDots": true}'>
										...
										<?php
										$queryCatalogo = "SELECT * FROM tab_catalogo WHERE Sucursal ='Multimarcas'";
