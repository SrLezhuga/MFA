						...
						<div class="col-12">
							...
							<div class="jumbotron jumbotron-fluid <?php echo $Sucursal; ?>">
								<div class="container">
									...
									<h1 class="wow  slideInDown" style="visibility: visible; color: #000000; animation-name: slideInDown;"><b><?php echo $Web['Titulo']; ?></b></h1>
									<p class="lead intro-text wow  slideInUp" style="visibility: visible; color: #000000;; animation-name: slideInUp;"><?php echo $Web['Sub_titulo']; ?></p>
								</div>
							</div>
